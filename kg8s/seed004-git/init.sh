...
EOF
# [kubectl wait works for Deployment, but does not for StatefulSet · Issue #79606 · kubernetes/kubernetes](https://github.com/kubernetes/kubernetes/issues/79606#issuecomment-779779928)
}
